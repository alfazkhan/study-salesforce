...
const FormContainer = styled.div`
  ${tw`p-10 sm:p-12 md:p-16 text-gray-100 rounded-lg relative bg-gray-900`}
  form {
    ${tw`mt-4`}
  }
  h2 {
              ...
              <TwoColumn>
                ...
                <Column>
                  <InputContainer tw="flex-1">
                    <Label htmlFor="name-input">Your preferred Courses</Label>
                    <TextArea id="message-input" name="message" placeholder="E.g. Courses you are intreted in"/>
                  </InputContainer>
                </Column>
              </TwoColumn>
